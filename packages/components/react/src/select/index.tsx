...
/**
 * The parts under their short names, so `import * as Select` gives a namespace
 ...
 * `Select.Root` is `undefined` in a server component.
 *
 ...
 */
export { Value, Trigger, Content, Item, Label, Separator };
export const { Root, Group } = Select;
