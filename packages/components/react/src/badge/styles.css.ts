...
const { accent, background, neutral, status } = vars.color.$semantic;
...
export const badgeRecipe = recipe({
  ...
  variants: {
     ...
     */
    tone: {
      neutral: { color: neutral.strong, backgroundColor: neutral.surface },
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      style: { color: neutral.onNormal, backgroundColor: neutral.normal },
    },
     ...
     */
    {
      ...
      style: { backgroundColor: background.raised, borderColor: neutral.subtle },
    },
    {
