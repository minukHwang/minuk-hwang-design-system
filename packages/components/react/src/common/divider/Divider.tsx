...
interface DividerProps
  ...
  margin?: keyof typeof vars.spacing;
}
 ...
 * @param {PaletteColors} [props.color='neutral200'] - 구분선의 색상 (선택, 기본값: 'neutral200')
 * @param {keyof typeof vars.spacing} [props.size=1] - 구분선의 두께 (선택, 기본값: 1)
 * @param {keyof typeof vars.spacing} [props.margin] - 구분선의 여백 (선택)
...
export const Divider = forwardRef<HTMLHRElement, DividerProps>(
  (
    { orientation = 'horizontal', color = 'neutral200', size = 1, margin, className, ...props },
    ref
  ) => {
    return (
      <Container
