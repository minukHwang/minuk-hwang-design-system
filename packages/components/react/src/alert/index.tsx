...
/**
 * The parts under their short names, so `import * as Alert` gives a namespace
 ...
 * `Alert.Root` is `undefined` in a server component.
 *
 ...
 */
export { Root, Body, Title, Description, Action, AlertIcon as Icon };
