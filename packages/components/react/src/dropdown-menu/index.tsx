...
/**
 * The parts under their short names, so `import * as DropdownMenu` gives a namespace
 ...
 * `DropdownMenu.Root` is `undefined` in a server component.
 *
 ...
 */
export { Content, Item, CheckboxItem, RadioItem, Label, Separator, SubTrigger, SubContent };
export const { Root, Trigger, Group, RadioGroup, Sub } = DropdownMenu;
